...
void rightBorder()
{
    ...
    cout << "(*)\n";
    consoleCoordinates(100, 43);
    cout << "(*)\n";
    consoleCoordinates(100, 44);
    cout << "(*)\n";
    consoleCoordinates(100, 45);
    cout << "(*)\n";
    consoleCoordinates(100, 46);
    cout << "(*)\n";
...
// Function for viewing the options for the quiz 
void quizMenu()
{
    SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 7);
    consoleCoordinates(35, 10);
...
void hintFirstBgEmpire(int number, int id, int correct, int incorrect, int skipped)
{
    ...
    consoleCoordinates(15, 11);
    cout << "The first digit of the start reign year: " << grayToBin(number);
...
void hintSecondBgEmpire(int number, int id, int correct, int incorrect, int skipped)
{
    ...
    cout << "There is a special hint that you can use to write the right answer\n";
    consoleCoordinates(15, 11);
    cout << "The second digit of the start reign year: " << grayToBin(number);
